...
export class NotificationListPage extends BasePage {
  ...
  override async ngOnInit() {
    this.notifications = [
      { Date: '2023-04-01', Type: 'Message', Sender: 'John Doe', IsOpened: false },
      { Date: '2023-04-02', Type: 'Alert', Sender: 'Jane Smith', IsOpened: true },
      { Date: '2023-04-03', Type: 'Update', Sender: 'Acme Inc.', IsOpened: false },
      { Date: '2023-04-01', Type: 'Message', Sender: 'John Doe', IsOpened: true },
      { Date: '2023-04-02', Type: 'Alert', Sender: 'Jane Smith', IsOpened: true },
      { Date: '2023-04-03', Type: 'Update', Sender: 'Acme Inc.', IsOpened: false },
      { Date: '2023-04-01', Type: 'Message', Sender: 'John Doe', IsOpened: false },
      { Date: '2023-04-02', Type: 'Alert', Sender: 'Jane Smith', IsOpened: true },
      ...
      { Date: '2023-04-03', Type: 'Update', Sender: 'Acme Inc.', IsOpened: false },
      { Date: '2023-04-01', Type: 'Message', Sender: 'John Doe', IsOpened: true },
      { Date: '2023-04-02', Type: 'Alert', Sender: 'Jane Smith', IsOpened: false },
      { Date: '2023-04-03', Type: 'Update', Sender: 'Acme Inc.', IsOpened: false },
      { Date: '2023-04-01', Type: 'Message', Sender: 'John Doe', IsOpened: false },
      { Date: '2023-04-02', Type: 'Alert', Sender: 'Jane Smith', IsOpened: true },
      { Date: '2023-04-03', Type: 'Update', Sender: 'Acme Inc.', IsOpened: false },
  ...
  viewFullNotification(notification) {
    ...
    if (notification.Type == "Invitation" && notification.theType == "PendingAuthorization") {
      ...
      if (notification.Suggestion != null) {
        ...
        //call the event opened api 
        this.notificationEventOpened(id, notification)
      } else if (notification.Type == 'Denied Authorization Request' && notification.theType == "DeniedAuthorization") {
        id = notification.callID;

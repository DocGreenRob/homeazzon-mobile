...
@Component({
  selector: 'app-master-bedroom-category',
  templateUrl: './master-bedroom-category.component.html',
  styleUrls: ['./master-bedroom-category.component.scss'],
})
export class MasterBedroomCategoryComponent  extends BasePage {
  userId: any;

...
export class BasePage implements OnInit {
  ...
  get SelectedProperty(): IPropertyDto {
    const info: any = this.storageService.get('SelectedProperty');
    return info;
  }
  set SelectedProperty(value: IPropertyDto) {
  ...
  set IsEditingProperty(value: boolean) {
